...
├── styles.css           # Minimalist, Apple-style CSS (No gradients, Atria Red)
├── script.js            # Client-side interface & chat interaction logic
├── projects.js          # 220 indexed ASIP project records
