/* ═══════════════════════════════════════════════════════════════
   ADRA Intelligence — Client Engine (Chat & Intelligence Explorer)
...
async function openModal(id) {
  ...
  try {
    ...
    const deptCode = (p.dept || "").toLowerCase();
    const deptChip = `<span class="badge-dept dept-${deptCode}">${esc(p.dept)}</span>`;
